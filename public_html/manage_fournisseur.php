...
<html>
    ...
    <body id="page-top">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <h1 align="center" class="titleH1">Gestion des Fournisseurs</h1>
                        <br>
                        <div class="text-center">
                            <a href="#" data-toggle="modal" data-target="#form_fournisseur" class="btn btn-primary" style="width: 200px;height: 40px;"><i class="fa fa-plus">&nbsp;</i>Ajouter Fournisseur</a>
                        </div>
                        <br>
                        <br>
        ...
        include_once("./templates/update_fournisseur.php");
        ?>
