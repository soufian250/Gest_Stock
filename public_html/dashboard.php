		...
		<div class="row">
			<div class="col-md-4">
				<div class="card mx-auto">
					<div class="card-body"><h2>Welcome Admin</h2></div>
			...
			<div class="col-md-8">
				<div class="jumbotron" style="width:100%;height:100%;">
					<div class="row">
						...
						<div class="col-md-4"><?php include_once("./Clock/clock.html"); ?></div>
					</div>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="card">
					<div class="card-body">
						...
						<p class="card-text">Here you can manage your employes add new one delete or update</p>
						<a href="#" data-toggle="modal" data-target="#form_category" class="btn btn-primary">Add</a>
						<a href="manage_categories.php" class="btn btn-primary">Manage</a>
					</div>
				</div>
			...
			<div class="col-md-4">
				<div class="card">
						...
						<p class="card-text">Here you can manage show your Invoices and manage them</p>
						<a href="#" data-toggle="modal" data-target="#form_products" class="btn btn-primary">Show</a>
						<a href="manage_product.php" class="btn btn-primary">Manage</a>
					</div>
				</div>
			</div>
